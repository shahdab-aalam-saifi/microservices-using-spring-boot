...
public class EchoHandlerIntegrationTest {
  ...
  public void shouldSendAndReceiveMessage() throws Exception {
    ...
    StompSession stompSession = connectAndSubscribe(answer);
  ...
  private StompSession connectAndSubscribe(CompletableFuture<String> answer)
    ...
    StompSession stompSession =
        stompClient.connect(uri, new StompSessionHandlerAdapter() {}).get(1, TimeUnit.SECONDS);
    stompSession.subscribe("/topic/echo", new TestStompFrameHandler(answer));
