package com.saalamsaifi.jdbc.template;
...
import com.saalamsaifi.jdbc.template.model.Customer;

@SpringBootApplication
public class SpringBootJdbcTemplateApplication implements CommandLineRunner {
  private static final Logger log =
      LoggerFactory.getLogger(SpringBootJdbcTemplateApplication.class);
