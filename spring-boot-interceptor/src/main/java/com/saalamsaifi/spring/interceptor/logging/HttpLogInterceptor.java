...
public class HttpLogInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
			throws Exception {
		LOGGER.info("user@{} is requesting for resource at {}", request.getRemoteAddr(), request.getRequestURI());
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
		...
		LOGGER.info("user@{} consumed resource at {} for {}ms", request.getRemoteAddr(), request.getRequestURI(),
				consumed);
	}
}
