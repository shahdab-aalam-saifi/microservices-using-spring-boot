...
public class OrderController {
  ...
  @Autowired private OrderResourceAssembler assembler;
  ...
  public Resources<Resource<Order>> all() {
    ...
    List<Resource<Order>> orders =
        orderRepository.findAll().stream().map(assembler::toResource).collect(Collectors.toList());
